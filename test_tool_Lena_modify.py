...
if __name__ == '__main__':
    ...
    table.write(0, 2, 'human_domain')
    table.write(0, 3, 'domain')
    table.write(0, 4, 'human_intent')
    table.write(0, 5, 'intent')
    table.write(0, 6, 'human_subintent')
    table.write(0, 7, 'subintent')
    ...
    for i in range(1, sheet.nrows):
        ...
        table.write(i, 2, row[2])
        table.write(i, 4, row[3])
        table.write(i, 6, row[4])

        requestslist = sendjsondata(row[1])
        if len(requestslist) == 1:
            # print(requestslist)
            table.write(i, 3, requestslist[0][0])
            table.write(i, 5, requestslist[0][2])
            table.write(i, 7, requestslist[0][4])
            ...
            # print('2:',i)
            table.write(i, 3, requestslist[0][0]+'/'+requestslist[1][0])
            table.write(i, 5, requestslist[0][2]+'/'+requestslist[1][2])
            table.write(i, 7, requestslist[0][4]+'/'+requestslist[1][4])
            ...
            # print('3:',i)
            table.write(i, 3, requestslist[0][0] + '/' + requestslist[1][0]+ '/' + requestslist[2][0])
            table.write(i, 5, requestslist[0][2] + '/' + requestslist[1][2]+'/' + requestslist[2][2])
            table.write(i, 7, requestslist[0][4] + '/' + requestslist[1][4]+ '/' + requestslist[2][4])
